...
class GeolangLexer extends Lexer_1.Lexer {
    // tslint:enable:no-trailing-whitespace
    constructor(input) {
        super(input);
        this._interp = new LexerATNSimulator_1.LexerATNSimulator(GeolangLexer._ATN, this);
    }
    // @Override
    // @NotNull
    get vocabulary() {
    ...
    // @Override
    get grammarFileName() { return "GeolangLexer.g4"; }
    // @Override
    get ruleNames() { return GeolangLexer.ruleNames; }
    // @Override
    get serializedATN() { return GeolangLexer._serializedATN; }
    // @Override
    get channelNames() { return GeolangLexer.channelNames; }
    // @Override
    get modeNames() { return GeolangLexer.modeNames; }
    static get _ATN() {
        if (!GeolangLexer.__ATN) {
            GeolangLexer.__ATN = new ATNDeserializer_1.ATNDeserializer().deserialize(Utils.toCharArray(GeolangLexer._serializedATN));
        }
        return GeolangLexer.__ATN;
    }
}
exports.GeolangLexer = GeolangLexer;
GeolangLexer.MultiLineComment = 1;
GeolangLexer.SingleLineComment = 2;
GeolangLexer.OpenBracket = 3;
GeolangLexer.CloseBracket = 4;
GeolangLexer.OpenParen = 5;
GeolangLexer.CloseParen = 6;
GeolangLexer.OpenBrace = 7;
GeolangLexer.CloseBrace = 8;
GeolangLexer.SemiColon = 9;
GeolangLexer.Comma = 10;
GeolangLexer.QuestionMark = 11;
GeolangLexer.Colon = 12;
GeolangLexer.Dot = 13;
GeolangLexer.Plus = 14;
GeolangLexer.Minus = 15;
GeolangLexer.Not = 16;
GeolangLexer.Multiply = 17;
GeolangLexer.Divide = 18;
GeolangLexer.Modulus = 19;
GeolangLexer.LessThan = 20;
GeolangLexer.MoreThan = 21;
GeolangLexer.LessThanEquals = 22;
GeolangLexer.GreaterThanEquals = 23;
GeolangLexer.Equals_ = 24;
GeolangLexer.NotEquals = 25;
GeolangLexer.And = 26;
GeolangLexer.Or = 27;
GeolangLexer.Layer = 28;
GeolangLexer.Scene = 29;
GeolangLexer.Import = 30;
GeolangLexer.From = 31;
GeolangLexer.As = 32;
GeolangLexer.Use = 33;
GeolangLexer.Where = 34;
GeolangLexer.Default = 35;
GeolangLexer.Log = 36;
GeolangLexer.Identifier = 37;
GeolangLexer.DecimalLiteral = 38;
GeolangLexer.StringLiteral = 39;
GeolangLexer.Tab = 40;
GeolangLexer.WhiteSpace = 41;
GeolangLexer.LineTerminator = 42;
GeolangLexer.UnexpectedCharacter = 43;
GeolangLexer.WS_CHANNEL = 2;
GeolangLexer.ERROR = 3;
// tslint:disable:no-trailing-whitespace
GeolangLexer.channelNames = [
    "DEFAULT_TOKEN_CHANNEL", "HIDDEN", "WS_CHANNEL", "ERROR",
];
// tslint:disable:no-trailing-whitespace
GeolangLexer.modeNames = [
    "DEFAULT_MODE",
];
GeolangLexer.ruleNames = [
...
GeolangLexer.VOCABULARY = new VocabularyImpl_1.VocabularyImpl(GeolangLexer._LITERAL_NAMES, GeolangLexer._SYMBOLIC_NAMES, []);
GeolangLexer._serializedATN = "\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x02-\u0174\b\x01" +
...
//# sourceMappingURL=GeolangLexer.js.map